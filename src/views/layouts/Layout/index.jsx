...
const Layout = ({ children }) => {
  ...
  return (
    ...
    <div className="layout-container">
      <AppBar position="static" color="transparent" sx={{ boxShadow: "none" }}>
        <Container>
          <Toolbar sx={{ justifyContent: "center" }}>
            ...
            <Box
              sx={{
                display: { xs: "flex", flexGrow: 1, md: "none" },
                justifyContent: "center",
              }}
              className="nav-links-container"
            >
            ...
            >
              ...
              >
                ...
                >
                  <Link to={"/recibe"} className="menu-item">
                    Recibir
                  </Link>
                </MenuItem>
                <MenuItem
                ...
                >
                  <Link to={"/envia"} className="menu-item">
                    Enviar
                  </Link>
                </MenuItem>
                <MenuItem
                ...
                >
                  <Link to={"/retira"} className="menu-item">
                    Vender AXN
                  </Link>
                </MenuItem>
              </Menu>
      ...
      <Container style={{ paddingBottom: 60 }}>{children}</Container>
